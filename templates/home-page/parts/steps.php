  ...
  <div class="steps__container container">
    ...
    <div class="steps__grid">
      <article class="steps__item step step--large step--hover">
        ...
        <h3 class="step__title">Пробное бесплатное занятие</h3>
        <p class="step__descr">На пробном беслпатном занятии тренер определяет уровень подготовки ребенка и физические данные.
