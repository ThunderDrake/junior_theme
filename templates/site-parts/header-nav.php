  ...
  <div class="navigation__container container">
    <nav class="navigation__nav nav" title="Навигация по сайту">
      <ul class="nav__list list-reset">
        ...
        <li class="nav__item"><a href="/commands/" class="nav__link" data-menu-item>Сборные команды клуба</a></li>
      </ul>
    </nav>
    <div class="navigation__contacts">
      <div class="navigation__contacts-group">
        <div class="navigation__contacts-label">Телефон:</div>
        <a class="navigation__contacts-item navigation__contacts-item--big hover-opacity" href="tel:<?= get_field('home_main_phone', 'option') ? cth()->format_phone(get_field('home_main_phone', 'option')) : '' ?>"><span data-text="<?= get_field('home_main_phone', 'option') ?: '' ?>"><?= get_field('home_main_phone', 'option') ?: '' ?></span></a>
        <a class="navigation__contacts-item hover-opacity" href="tel:<?= get_field('home_main_phone_first', 'option') ? cth()->format_phone(get_field('home_main_phone_first', 'option')) : '' ?>"><span data-text="<?= get_field('home_main_phone_first', 'option') ?: '' ?>"><?= get_field('home_main_phone_first', 'option') ?: '' ?></span></a>
        <a class="navigation__contacts-item hover-opacity" href="tel:<?= get_field('home_main_phone_second', 'option') ? cth()->format_phone(get_field('home_main_phone_second', 'option')) : '' ?>"><span data-text="<?= get_field('home_main_phone_second', 'option') ?: '' ?>"><?= get_field('home_main_phone_second', 'option') ?: '' ?></span></a>
      </div>
      <div class="navigation__contacts-group">
        <div class="navigation__contacts-label">Почта:</div>
        <a class="navigation__contacts-item navigation__contacts-item--big hover-opacity" href="mail:<?= get_field('home_email', 'option') ?: '' ?>"><span data-text="<?= get_field('home_email', 'option') ?: '' ?>"><?= get_field('home_email', 'option') ?: '' ?></span></a>
      </div>
    </div>
  </div>
</div>
